...
export function createIssueDiagnosisPattern(
  ...
  return {
    ...
    failure_semantics: {
      ...
      investigation: "preserve disagreement and limitations for arbitration",
    ...
    workflow_template: {
      ...
      spec: {
        ...
        edges: [
          ...
          { from: "review_dataflow.reviewed", to: "arbitrate.dataflow" },
          { from: "review_history.reviewed", to: "arbitrate.history" },
          ...
          { from: "review_reproduction.reviewed", to: "verify_scenario.reproduction" },
          { from: "review_reproduction.reviewed", to: "verify_evidence.reproduction" },
          { from: "review_reproduction.reviewed", to: "verify_adversarial.reproduction" },
          { from: "review_dataflow.reviewed", to: "verify_scenario.dataflow" },
          { from: "review_dataflow.reviewed", to: "verify_evidence.dataflow" },
          { from: "review_dataflow.reviewed", to: "verify_adversarial.dataflow" },
          { from: "review_history.reviewed", to: "verify_scenario.history" },
          { from: "review_history.reviewed", to: "verify_evidence.history" },
          { from: "review_history.reviewed", to: "verify_adversarial.history" },
